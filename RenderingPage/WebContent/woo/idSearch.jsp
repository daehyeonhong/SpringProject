...
<body>
	<div class="container col-sm-3">
		<div align="center">
			<h2>아이디 찾기</h2>
			<p align="center" style="font-size: 16px; line-height: 26px;">회원가입
				시 사용하신 회원정보로 아이디를 찾을 수 있습니다.</p>

			<img onclick="emailSend()"
				style="cursor: pointer" src="images/e-mail_2.png" class="square"
				width="100" height="100">

			<ul
				style="text-align: left; font-size: 14px; line-height: 26px; list-style: square;">
				...
				<li>위 방법으로 아이디를 찾을 수 없는 경우 SK렌터카 고객센터로 연락주시기 바랍니다.<br> <span
					class="text-warning">고객센터 1599-9111</span> (월 ~ 금 09:00 ~ 18:00/토요일
					및 공휴일 휴무)
				</li>
			</ul>
		</div>
