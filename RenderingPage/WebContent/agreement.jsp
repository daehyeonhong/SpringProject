	...
	<div class="container col-sm-8" align="center">
		...
		<form action="#">
			...
			<table class="table table-bordered col-sm-8">
				...
				<tbody>
					<tr>
						<td><p class="overflow-auto p-3" style="max-height: 100px">
							제1조(목적) 
본 약관은 SK렌터카 주식회사(이하 "회사"라 한다)가 운영하는 SK렌터카 서비스를 이용함에 있어 회사와 회원의 권리와 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제2조 (정의) 
① "SK렌터카"라 함은 회사가 제8조에 명기된 서비스를 회원에게 제공하기 위하여 구축한 온라인 사이트, 회사가 운영하는 차량대여 렌터카사무소 등 향후 회사가 영위하게 될 제반 사업 일체 등을 운영하는 사업자의 의미로 사용합니다.
② "회원"이라 함은 SK렌터카가 정한 절차에 따라 회원가입을 하여 SK렌터카가 제공하는 서비스를 이용할 수 있는 권한을 부여 받은 자를 말합니다.

제3조 (약관의 개정)
① 본 약관은 수시로 개정 가능하며 약관을 개정하고자 할 경우 SK렌터카는 개정된 약관을 적용하고자 하는 날(이하 "효력 발생일")로부터 30일 이전에 약관이 개정된다는 사실과 개정된 내용 등을 다음 각 호에 규정된 방법 중 1가지 이상의 방법으로 회원에게 고지합니다.
1. E-mail통보 
2. 서면통보 
3. SK렌터카 사이트를 통한 게시 
4. 오프라인 지점 등을 통한 게시 
② SK렌터카가 E-mail통보 또는 서면통보의 방법으로 본 약관이 개정된 사실 및 개정된 내용을 회원에게 고지하는 경우에, SK렌터카는 회원이 SK렌터카에 기제공한 E-mail 주소나 주소지 중 가장 최근에 제공된 곳으로 통보하며, 약관 제19조 2항에 따라 회원이 최근의 정보로 변경하지 않아 발생한 손해에 대해서는 SK렌터카는 어떠한 책임도 지지 않습니다.
③ 규정에 의하여 개정된 약관(이하 "개정 약관")은 원칙적으로 그 효력 발생일로부터 장래에 향하여 유효합니다.
④ 본 약관의 개정과 관련하여 이의가 있는 회원은 회원탈퇴를 할 수 있습니다. 단, 이의가 있음에도 불구하고 본 조 1항과 2항의 정해진 바에 따른 SK렌터카의 고지가 있은 후 30일 이내에 회원탈퇴를 하지 않은 회원은 개정 약관에 동의한 것으로 간주합니다.
⑤ 본 규정의 통지방법 및 통지의 효력은 본 약관의 각 조항에서 규정하는 개별적인 또는 전체적인 통지의 경우에도 이를 준용합니다.

제4조 (약관의 해석)
본 약관에 명시되지 않은 사항에 대해서는 약관의 규제에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 방문판매 등에 관한 법률, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령 및 회사가 정한 서비스의 세부이용지침 등의 규정에 의합니다.

제5조 (회원가입)
① SK렌터카의 회원이 되고자 하는 자는 SK렌터카가 정한 회원가입 절차에 의해 본 약관과 별도의 ‘개인정보의 수집 및 이용에 대한 안내’ 및 ‘개인정보의 위탁’에 동의함으로써 회원가입을 신청합니다.
...
제9조 (서비스의 변경 및 중단)
① SK렌터카는 사업종목의 전환, 업체간의 통합, 사업폐지 불가피한 영업상의 이유 등으로 제공하는 서비스의 내용을 변경할 수 있습니다. 이 경우에는 변경된 서비스의 내용 및 제공일자를 명시하여 현재의 서비스 내용을 게시한 곳에 그 제공일자 이전 30일 전부터 공지합니다. 단, 변동내용을 구체적으로 공지하기가 불가능한 경우에는 30일 전에 그 취지 및 공지가 불가능한 변동사유를 현재의 서비스를 게시한 곳에 공지합니다.
...
제10조 (구매신청) 
회원은 SK렌터카에서 다음 각 호의 절차에 따라 재화 또는 용역의 구매를 신청하며, SK렌터카는 재화 또는 용역의 성격에 따라 이러한 절차를 변경할 수 있으며, 이 경우 회원이 구매신청 이전에 변경된 절차를 확인할 수 있도록 안내합니다.
...
4. 기타 SK렌터카가 인정하는 방법 
② 위 제1항에도 불구하고, 차량 단기대여 서비스의 경우에는 대여요금 결제 시 신용카드 결제를 우선으로 하고, 현금으로 결제하는 경우 회사는 별도의 보증을 요구할 수 있으며 금융상의 신용정보 조회에 대한 동의를 요구할 수 있습니다. 회원이 이에 동의하지 않거나 신용상태가 부적절하다고 판단되는 경우 대여가 불가능할 수 있습니다.

제13조 (수신확인통지•구매신청 변경 및 취소)
① SK렌터카는 회원의 구매신청이 있는 경우 회원에게 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시하고 수신확인통지를 합니다.
② 수신확인통지를 받은 회원은 의사표시의 불일치 등이 있는 경우에는 수신확인 통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고, SK렌터카는 계약의 성립 전에 회원의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다.
③ SK렌터카는 회원이 구매 신청한 재화 또는 용역이 품절 또는 기타 부득이한 사유가 발생하여 재화 또는 용역의 제공이 불가능할 경우 이를 즉시 회원에게 통지하며, 당해 통지가 이루어진 시점에 기존 구매계약은 취소된 것으로 봅니다.

제14조 (청약철회 등)
① SK렌터카와 재화 등의 구매에 관한 계약을 체결한 회원은 수신확인의 통지를 받은 날부터 7일 이내에는 청약의 철회를 할 수 있습니다. 다만, 자동차 장기대여 계약의 경우에는 해당 계약에서 정하는 바에 따릅니다.
...
③ 제2항에도 불구하고, 자동차 장기대여 계약은 소비자의 주문에따라 개별적으로 발주되는 자동차의 대여에 관한 것으로서 청약 철회 시 SK렌터카에 회복할 수 없는 피해가 발생하고 거래의 안전이 위협받으므로 해당 계약에서 별도로 정하는 바에 따릅니다.


제15조 (청약철회 등의 효과)
① SK렌터카는 회원 또는 이용자로부터 재화 등을 반환 받은 경우 5영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다.
② SK렌터카는 위 대금을 환급함에 있어서 회원이 신용카드 또는 전자화폐 등의 결제수단으로 재화 등의 대금을 지급한 때에는 지체 없이 당해 결제수단을 제공한 사업자로 하여금 재화 등의 대금의 청구를 정지 또는 취소하도록 요청합니다.
③ 청약철회 등의 경우 공급받은 재화 등의 반환에 필요한 비용은 회원이 부담합니다. 다만 재화 등의 내용이 표시•광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 재화 등의 반환에 필요한 비용은 SK렌터카가 부담합니다.
④ 제1항 내지 제3항의 규정에도 불구하고 자동차 장기대여 계약의 경우에는해당 계약서에서 정한 바에 따릅니다.

제16조 (환급, 반품 및 교환) 
① SK렌터카는 회원이 구매 신청한 재화 또는 용역이 품절 등의 사유로 재화의 인도 또는 용역의 제공을 할 수 없을 때에는 지체 없이 그 사유를 회원에게 통지하고, 그 통지일로부터 3일 이내에 계약해제 및 환급절차를 취합니다.
...
제17조 (개인정보보호) 
① SK렌터카는 회원의 개인정보 수집 시 회원관리에 필요한 최소한의 정보만을 필수사항으로 수집하고 있으며, 최적화되고 고객지향적인 마케팅을 수행하기 위해 필요한 이외의 정보를 선택사항으로 수집하고 있습니다. 회사는 개인정보 수집 시 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.
② 회원은 SK렌터카에 제공한 등록정보와 관련하여 변경사항이 있는 경우에는 지체 없이 SK렌터카에 그 변경사실을 통지하여야 하며, 이를 위반하여 발생한 일체의 손해에 대하여 SK렌터카는 어떠한 책임도 지지 않습니다.
③ SK렌터카가 수집하는 개인 정보 및 항목은 서비스 변경이나 SK렌터카의 사정에 따라 변경 가능합니다. 이 경우 회원에게 변경사항을 약관 제3조 1항의 방법으로 통지하고 동의를 얻으며, 별도의 약관 변경절차는 생략합니다.
...
SK렌터카 통합사이트와 다른 피연결회사(회사의 서비스 화면과 링크 등으로 연결된 사이트를 운영하는 회사를 말합니다)는 독자적으로 운영되며, SK렌터카는 회원과 피 연결회사간에 이루어진 일체의 거래에 대해서 어떠한 책임도 지지 않습니다.

제21조 (저작권의 귀속 및 이용제한) 
① SK렌터카가 작성한 저작물에 대한 저작권 기타 지적재산권은 SK렌터카에 귀속합니다.
② 회원은 SK렌터카를 이용함으로써 얻은 정보를 SK렌터카의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다. 

제22조 (공개게시물의 삭제) 
회원의 공개게시물의 내용이 다음 각 호에 해당되는 경우 SK렌터카는 회원에게 사전 통지 없이 공개게시물을 삭제할 수 있고 해당 회원의 회원 자격을 제한 및 정지 또는 상실시킬 수 있습니다.
