...
<form class="col-sm-12" action="#">
  ...
  <tr class="row"><!-- col-sm-10 -->
  	<td class="col-sm-5">
  		...
  		&nbsp;
  			<button type="button" class="btn btn-dark col-sm-4" onclick="location.href='show_map.jsp'">지도보기</button>
  			</div>
  			</div>
  	</td>
  	<td class="col-sm-5">
...
<div class="col-sm-12">
  <table style="width: 100%">
  	<tr class="border row">
  		<td class="col btn btn-outline-warning"><p></p><p>선택안함</p></td>
...
<div class="comment row col-sm-6"><h3>계약자 정보입력 (제1운전자)</h3>
</div>
<hr>
<div class="col-sm-12">
...
<div class="col"></div>
<div class="row col">
<button type="button" class="btn col border"  id="cancel">취소</button><!--초기화 -->
&nbsp;
