			...
			<div class="row" style="text-align: center; margin: 0;">
				<ul class="container nav nav-pills bg-light" role="tablist">
					<li class="col nav-item"><a class=" nav-link active"
						data-toggle="pill" href="#home"> 일반상담</a></li>
					<li class="col nav-item"><a class="nav-link"
						data-toggle="pill" href="#menu1">렌터카상담</a></li>
					<li class="col nav-item"><a class="col nav-link"
						data-toggle="pill" href="#menu2">상담안내</a></li>
				</ul>
			</div>
			<!-- Tab panes -->
				...
				<div class="form-group">
					...
					<div class="row">
						<input type="text" class="col" name="phone"
							placeholder="휴대폰 번호(-없이) 입력" /> <input type="email" class="col"
