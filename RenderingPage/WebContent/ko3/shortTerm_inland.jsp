...
<br>
  <br>
  <div class="comment row col-sm-6"><h3>기간/지점 선택</h3>&nbsp;<span class="float-right" style="font-size: 12px;"><strong>기간ㆍ지점ㆍ차량</strong>은 순서와 관계없이 <strong>선택 예약이 가능</strong>합니다.</span></div>
  <!--  comment row글씨 아래로 -->
  <form action="#">
  <div class="option">
  <hr>
  ...
  <tr class="row">
     ...
     <div class="col-sm-12">
  	...
  	<td class="col-sm-2" align="center" rowspan="2" style="border:1px orange solid;" ><strong>총 대여시간</strong>
  								<p>0일 0시간 0분</p>
  	</td>
  </tr>
  <tr class="row"><!-- col-sm-10 -->
  	<td class="col-sm-5">
  		...
  		<select class="form-control col-sm-8" id="branch_jeju" name="branch_jeju">
  				<option>강남지점</option>
  				<option>하남지점</option>
  				<option>한양대지점</option>
  				<option>이태원지점</option>
  ...
  <br>
  <br>
 <div class="comment row col-sm-6"><h3>차량 선택</h3><span class="col float-right" style="font-size: 12px;">예약완료된 차량은 선택이 불가합니다.</span></div>
<hr>
  <table  class="table table-border">
  	<tr class="row border" align="center">
  		<td class="col border">전체</td>
  		<td class="col border"><img src="./resources/images/car_option1.gif"><p>소형</p></td>
  		<td class="col border"><img src="./resources/images/car_option2.gif"><p>중형</p></td>
  		<td class="col border"><img src="./resources/images/car_option3.gif"><p>대형</p></td>
  		<td class="col border"><img src="./resources/images/car_option4.gif"><p>승합</p></td>
  		<td class="col border"><img src="./resources/images/car_option5.gif"><p>SUV/5인승</p></td>
  		<td class="col border"><img src="./resources/images/car_option6.gif"><p>수입/전기차</p></td>
  	</tr>
...
<br>
 <div  class="comment row col-sm-5"><h3>차량손해면책제도 선택</h3>&nbsp;&nbsp;
 <svg class="float-right" style="color:orange;" width="1em" height="2em" viewBox="0 0 16 16" class="bi bi-question-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <table style="width: 100%">
  	...
  	<td class="col btn btn-outline-warning"><p>선택안함</p></td>
  		<td class="col btn btn-outline-warning">SUPER 자차<p>면책금 5만원</p></td>
  		<td class="col btn btn-outline-warning">PLUS 자차<p>면책금 10만원</p></td>
  		<td class="col btn btn-outline-warning">일반 자차<p>면책금 30만원</p></td>
  	</tr>
...
<p style="color: orange;">※ 실제 운전자 정보를 입력해주세요! 입력한 제1운전자와 예약자가 상이할 경우 대여가 제한될 수 있습니다.</p>
...
<hr>
<div class="form-group">
	<p>TT렌터카㈜는 적법하고 공정한 방법으로 개인정보를 수집하며, 고객의 개인정보를 최우선으로 생각하여 안전하게 보유·관리하고 있습니다.</p>
	<h5>개인정보 제공 활용 동의</h5>
