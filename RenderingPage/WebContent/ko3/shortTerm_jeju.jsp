...
<br>
  <br>
  <div class="comment row col-sm-12"><h3>기간/지점 선택</h3>&nbsp;<span class="float-right" style="font-size: 12px;"><strong>기간ㆍ지점ㆍ차량</strong>은 순서와 관계없이 <strong>선택 예약이 가능</strong>합니다.</span></div>
  <!--  comment row글씨 아래로 -->
  <form action="#">
  <div class="option">
  <hr>
 ...
 <svg class="float-right" style="color:orange;" width="1em" height="2em" viewBox="0 0 16 16" class="bi bi-question-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <table style="width: 100%">
  	<tr class="border row">
  		...
  		<td class="col btn btn-outline-warning">완전 자차<p>면책금 0원</p></td>
  		<td class="col btn btn-outline-warning">일반 자차<p>면책금 50만원</p></td>
  	</tr>
