...
<div class="container">
  ...
  <table class="table border">
    <tbody>
 	...
 	<div class="row"><h3 class="col-sm-12">상황별 안내사항<span style="font-size: 12px;">&nbsp;운행 중 문제 발생 시, 다음과 같은 절차에 의해 24시간 365일 최상의 긴급출동서비스를 제공하고 있습니다.</span></h3></div>
	<br>
	<div class="card">
  ...
  <ul class="container  nav nav-pills" role="tablist">
    <li class="col nav-item">
      <a class="row nav-link active bg-white" data-toggle="pill" href="#home11" style="color:black;height: 100%;text-align: center;"> <b style="font-size: 20px;">급속충전기</b></a>
    </li>
    <li class="col nav-item">
      <a class="row nav-link bg-white" data-toggle="pill" href="#menu11"style="color:black; height: 100%;text-align: center;"><b style="font-size: 20px;">완속충전기</b></a>
    </li>
  </ul>
  </div>
  <!-- Tab panes -->
  <div class="tab-content">
    <div id="home11" class="container tab-pane active"><br>
		...
		<hr>
		<br>
		<img class="col-sm-12" src="../resources/images/use_charge.gif">
		<br>
		<br>
		...
		<br>
		<br>
		<div class="row"><h3 class="col-sm-6">차량 급속충전구 작동법</h3></div>
		<hr>
			...
			<table>
				<tr class="row">
					<td class="col-sm-5">
    					...
    					<img class="card-img-top" src="../resources/images/howtouse_charge1.gif">
    					<div class="card-body">
     					 <div class="row card-text">
     					 	<b class="col-sm-4" style="color: orange">STEP 1&nbsp;</b><span class="col-sm-8"> 급속 충전구 오픈 버튼을 누르면 급속충전구 커버가
살짝 열립니다.</span>
     					 </div>
    					</div>
    					<br>
					...
					<td class="col-sm-5">
						<div class="card">
    					<img class="card-img-top" src="../resources/images/howtouse_charge2.gif">
    					<div class="card-body">
     					 <div class="row card-text">
     					 	<b class="col-sm-4" style="color: orange">STEP 2&nbsp;</b><span class="col-sm-8">급속충전구 커버를 완전히 열고 안쪽의 
급속충전기의 충전소켓을 연결하세요.</span>
     					 </div>
    					</div>
  						</div>
					</td>
      ...
      <div class="container"  style="width: 100%;" >
		...
		<br>
			<div class="col">
				<br>
				<h3>완속충전기</h3>
				<p>완속 충전기는 낮은 전압으로 충전을 하는 방법으로</p>
				<p>시간이 오래걸릴수 있으며 대게 오랜주차환경에서 사용합니다.</p>
				<p>(예, 자택, 직장, 숙박지 등) </p>
				<br>
				<button class="btn btn-md border" style="background-color: silver; color: white;"onclick="location.href='https://www.ev.or.kr/evmonitor;jsessionid=mQUkvclfQPQi8a8nz6RqaJwcNInXiprC65bMuxmdAzvwOFucVYMk11zHDgXwqikK.evciswas01_servlet_engine5'">가까운 충전소 찾기</button>
				<br>
		...
		<img class="col" class="img" src="../resources/images/solution_charge22.gif">
		</div>
	</div>
		<br>
		<br>
		
		<div class="row"><h3 class="col-sm-6">완속충전구 Open</h3></div>
		<hr>
	<br>
			<table>
				<tr class="row">
					<td class="col-sm-5">
						<div class="card" style="width: 100%;">
    					<img class="card-img-top" src="../resources/images/open_charge1.gif">
    					<div class="card-body">
     					 <div class="row card-text">
     					 	<b class="col-sm-4" style="color: orange">STEP 1&nbsp;</b><span class="col-sm-8"> 완속 충전구 오픈 버튼을 눌러 완속충전구를 여세요.</span>
     					 </div>
    					</div>
  						</div>
					</td>
					...
					<td class="col-sm-5">
						<div class="card">
    					<img class="card-img-top" src="../resources/images/open_charge2.gif">
    					<div class="card-body">
     					 <div class="row card-text">
     					 	<b class="col-sm-4" style="color: orange">STEP 2&nbsp;</b><span class="col-sm-8">완속충전구 커버를 완전히 열고 완속 충전기의
								충전소켓을 연결하세요.</span>
     					 </div>
    					</div>
  						</div>
				...
				<tr>
					...
					<div class="col-sm-6"></div>
						<div class="col-sm-6" style="text-align: right;">※ 급속 충전구 오픈 버튼과 충전구의 위치는
				차량의 종류에 따라 다를 수 있습니다.</div>
					</div>
      <br>
      <br>
      <br>
      			<div class="container"><div class="row"><h3>충전 커넥터 준비<span style="font-size: 12px;">&nbsp;차량 트렁크에 비치</span></h3></div></div>
    			<br>
    			<div class="card">
    				<img src="../resources/images/open_charge3.gif">
    			</div>
    </div>
  </div>
</div>
...
<p style="color: orange;">(보조배터리가 방전되면 견인을 하더라도 충전이 안됩니다.)</p></li>
    ...
    <thead>
      <tr>
        <th class="col" width="20px"	>구분<br></th>
        <th class="col" width="20%">소요시간</th>
        <th class="col" width="20%">연료량</th>
        <th class="col" width="20%">충전방식</th>
        <th class="col" width="30%" style="text-align: center;">비고</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>80%</td>
        <td>D콤보</td>
        <td>한번 충전으로 383Km 주행 가능합니다.
				(하루 40Km 주행 시, 1회 충전으로
				일주일 주행 가능)</td>
      </tr>
      <tr>
        <td>쏘울</td>
        ...
        <td>80%</td>
        <td>DC차데모</td>
        <td rowspan="3">충전 중, 종료하셔도 무방합니다.</td>
      </tr>
      <tr>
        <td rowspan="2"><br>SM3</td>
        <td>20~30분</td>
        <td>70%</td>
        <td rowspan="2">AC3상</td>
      </tr>
      <tr>
        <td>-</td>
        <td>100%</td>
      ...
      <div class="card-header">
        <a class="collapsed card-link" data-toggle="collapse" href="#collapseFive">
         차량 비치품 분실 시, 수수료가 발생(고객님 부담)
        </a>
      </div>
      <div id="collapseFive" class="collapse" data-parent="#accordion">
        <div class="card-body">
    		<ul>
    			<li>충전카드 분실 : 3,000 원</li>
    			<li>완속케이블 분실 : 300,000 원</li>
    		</ul>
  </div>
...
<div class="jumbotron" style="text-align: center;background-color: #F5F5F5;" ><!--   -->
	<b>TT렌터카만의 차별화 서비스!</b>
	<h3>TT 전기차<b style="color: orange;">장기렌터카 토탈 솔루션</b></h3>
