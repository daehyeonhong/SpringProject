			...
			<div class="row" style="padding-top: 10px;">
				<table style="width: 100%">
					...
					<td><img src="resources/images/icon_seat_off.png"></td> -->
						...
						<td><span>후방 카메라 ${car.back_camera == 1 ? '있음' : '없음'}</span>
						</td>
				...
				<table style="width: 100%">
					<tr class="border row">
						<c:forEach var="insurance" items="${insuranceList}" varStatus="i">
								<td class="col m-0 p-0" style="height: 100px;"><button type="button"
										class="col-sm-12 btn btn-outline-warning" id="addoption${i.index}"
										name="addoption${i.index}" value="${insurance.insurance_seq}" onclick="addop('addoption${i.index}')"
										style="height: 100%;">${insurance.insurance_name}</button></td>
						</c:forEach>
					</tr>
					<tr class="row">
						...
						<td colspan="3">
							<div class="form-group">
								...
								<ul>
									...
									<li>부가서비스 (카시트/유모차) 예약 및 문의는 TT렌터카 제주지점&nbsp;064-111-1111
										또는 홈페이지 www.TTrent.com 로 문의바랍니다.
			...
			<nav class="container navbar navbar-expand-sm navbar-dark bottom"
				...
				<div class="col-sm-3">
					<div class="row">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button type="button" class="btn col-sm-5 border float-right"
							id="calc" style="color: white; font-size: 15px;"
							onclick="reser()">예약하기</button>
					</div>
				</div>
			</nav>
		</div>
