      ...
      <form action="/short/detail" method="post" name="reserveForm2">
        <table class="table" id="table">
          ...
          <tr>
            <th>보험</th>
            <td>
              <select class="form-control" name="insurance_seq" id="insurance">
        ...
        <input name="sc_seq" id="sc_seq" value="${car.sc_seq}" />
        ...
        <input name="period" id="period" value="${period}" />
        <input name="nomal_price" value="${car.nomal_price}" />
      </form>
...
<script type="text/javascript">
  $().ready(function () {
    ...
    function reserve(parameter, callback) {
      ...
      let insurace_seq = parameter.insurance_seq;
