...
<article class="container">
			...
			<table class="col-sm-12 m-0 p-0">
				<tr>
					<td class="text-center" style="background-color:#F6F6F6;">대여 날짜</td>
					<td>&nbsp;</td>
					<td class="text-center" style="background-color:#F6F6F6;">반납 날짜</td>					
				</tr>
				<tr>
					<td>
						...
						+ segment_seq */ + ".json",
							function(data) {
								let html = "";
										...
										html += '<img style="width:100%; height:300px; border:1px solid #F6F6F6;" src="/resources/images/' + car.img_seq + '.jpg" class="card-img-top" alt="[' + car.license_plate + ']사진" />';
