        	...
        	<td>35,000</td>
  			...
  			<br>
				<div class="row">
					...
					<button class="border btn  btn-lg btn-light" data-toggle="pill" href="#menu2">제휴/할인 안내</button>
...
<br>
		...
		<div class="col">
      	<a href="#" class="border btn btn-lg disabled" aria-disabled="true"role="button">카드신청</a>
    	</div>
    	</div>
    	</div>
  		</div>
    	...
    	<div class="card-body">
      	<h4 class="card-title">아시아나 클럽</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 80%할인 / 주말 75%할인</h5>
  				<hr>
    	...
    	<div class="card-body">
      	<h4 class="card-title">클럽 SK 카드</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 80%할인 / 주말 75%할인</h5>
  				<hr>
		...
		<div class="row" align="center">
		<div class="col">
      	<a href="https://www.hanacard.co.kr/PI95500000C.web?_frame=no&CD_PD_SEQ=1638&CD_PD_KND_DV_NM=STD&INPTL_CDAPL_DC=4&NaPm=ct%3Dhm1lod7k%7Cci%3D0zC1003GOObgKpGb00i5%7Ctr%3Dcd%7Chk%3D065e4dc5a7f96ddaa9492ca72444ea9af9e13228&NVKWD=%ED%95%98%EB%82%98SK+CLUB+SK+%EC%B9%B4%EB%93%9C&NVADKWD=&NVAR=crd&NVADID=98+0zC1003GOObgKpGb00i5" class="border btn btn-lg stretched-link">카드신청</a>
    	</div>
    	</div>
    	</div>
  		</div>
    	...
    	<div class="card-body">
      	<h4 class="card-title">우리 타고싶은 카드</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 80%할인 / 주말 75%할인</h5>
  				<hr>
		...
		<div class="row" align="center">
		<div class="col">
      	<a href="https://sccd.wooribank.com/ccd/Dream?withyou=CDCIF0021&__STEP=1&CD_PRD_CD=227401" class="border btn btn-lg stretched-link">카드신청</a>
    	</div>
    	</div>
    	</div>
  		</div>
    	...
    	<div class="card-body">
      	<h4 class="card-title">우리 "마이카" 카드</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 80%할인 / 주말 75%할인</h5>
  				<hr>
    	...
    	<div class="card-body">
      	<h4 class="card-title">KB국민 직장인보너스 체크카드</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 80%할인 / 주말 75%할인</h5>
  				<hr>
	...
	<div class="row" align="center">
		<div class="col">
      	<a href="https://card.kbcard.com/CXPPPCAC0080.cms?mainCC=a&cooperationcode=01690" class="border btn btn-lg stretched-link">카드신청</a>
    	</div>
    	</div>
    	</div>
  		</div>
    	...
    	<div class="card-body">
      	<h4 class="card-title">SK가스 행복충전멤버십</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 85%할인 / 주말 80%할인</h5>
  				<hr>
  				<p>T 멤버십 일반/Silver/Gold/VIP등급 고객 해당</p>
  				<p>T 멤버십 內 VIP 라운지 > 생활/레저 예약가능(VIP등급 고객 해당) </p>
		</div>
    	...
    	<div class="card-body">
      	<h4 class="card-title">SK Family 카드</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 85%할인 / 주말 80%할인</h5>
  				<hr>
    	...
    	<div class="card-body">
      	<h4 class="card-title">법인거래처_임직원</h4>
      	<div class="card-text">
				<p>제주 이용 시 할인혜택</p>
  				<h5>[비수기] 주중 80%할인 / 주말 75%할인</h5>
  				<hr>
		...
		<div class="col">
  		...
  		<br>
  			<ul class="container">
  				...
  				<li><span style="color:orange;">성수기(준성수기, 극성수기 포함), 비수기 시즌에 따라 제주 할인율이 다르게 적용됩니다.</span></li>
