		...
		<div class="container-fluid">
			...
			<div
				...
				<h1 class="h3 mb-0 text-gray-800">
					<spring:message code="message.admin.index.dashboard" />
				</h1>
				<a href="#"
							...
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div
										...
										<spring:message code="message.admin.index.earnings-monthly" />
									</div>
							...
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div
										...
										<spring:message code="message.admin.index.earnings-annual" />
									</div>
							...
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div
										...
										<spring:message code="message.admin.index.tasks" />
									</div>
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
							...
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div
										...
										<spring:message code="message.admin.index.pending-requests" />
									</div>
					...
					<div class="card shadow mb-4">
						...
						<div
							...
							<h6 class="m-0 font-weight-bold text-primary">
								<spring:message code="message.admin.index.earnings-overview" />
							</h6>
				...
				<div class="col-xl-4 col-lg-5">
					<div class="card shadow mb-4">
						...
						<div
							class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
							<h6 class="m-0 font-weight-bold text-primary">
								<spring:message code="message.admin.index.revenue-sources" />
							</h6>
							<div class="dropdown no-arrow">
								<a class="dropdown-toggle" href="#" role="button"
									id="dropdownMenuLink" data-toggle="dropdown"
						...
						<div class="card-body">
							...
							<div class="mt-4 text-center small">
								<span class="mr-2"> <i class="fas fa-circle text-primary"></i>
									<spring:message code="message.admin.index.longterm-rent" />
								</span> <span class="mr-2"> <i
									class="fas fa-circle text-success"></i> <spring:message
										code="message.admin.index.shortterm-rent" />
