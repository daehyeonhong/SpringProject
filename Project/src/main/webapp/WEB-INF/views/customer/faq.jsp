		...
		<div class="container">
			<div class="container">
				<div class="row">
						...
						<a class="btn btn-${type != '2' ? 'outline-' : ''}dark col-sm-2" href="?type=2">장기</a>
						<a class="btn btn-${type != '3' ? 'outline-' : ''}dark col-sm-2" href="?type=3">단기</a>
						<a class="btn btn-${type != '4' ? 'outline-' : ''}dark col-sm-2" href="?type=4">전기차</a>
				</div>
			</div>
			<hr>
		</div>
