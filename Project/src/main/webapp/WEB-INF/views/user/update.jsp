				...
				<tr>
					<td colspan="2">
						<div class="input-group mb-3">
							...
							<input class="form-control" name="users_nickname"
								id="users_nickname" value="${users.users_nickname}" readonly>
				...
				<tr>
					<td colspan="2">
						<div class="input-group mb-3">
							...
							<input class="form-control" name="users_phone" id="users_phone"
								value="${users.users_phone}" readonly>
							<div class="input-group-append">
				...
				<tr>
					<td colspan="2">
						<div class="input-group mb-3">
							...
							<input class="form-control" name="users_email" id="users_email"
								value="${users.users_email}" readonly>
							<div class="input-group-append">
				...
				<tr>
					<td colspan="2">
						<div class="input-group mb-3">
							...
							<input class="form-control" name="license" id="license"
								value="${users.license}" readonly>
							<div class="input-group-append">
						...
						$("#users_phone")
								.blur(
										function() {
											...
											let v = "${users.users_phone}";
											let user_phone = $('#users_phone')
													.val();
											let idJ = /^\d{3}-\d{3,4}-\d{4}$/;
											$
													.ajax({
														url : '${pageContext.request.contextPath}/user/phoneCheck?users_phone='
																+ user_phone,
														type : 'get',
														success : function(data) {
															console
						...
						$("#users_email")
								.blur(
										function() {
											...
											let v = "${users.users_email}";
											let user_email = $('#users_email')
													.val();
											let idJ = /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i;

											$
													.ajax({
														url : '${pageContext.request.contextPath}/user/emailCheck?users_email='
																+ user_email,
														type : 'get',
														success : function(data) {
															console
