...
<div class="container col-sm-6" align="center">
	<nav class="navbar navbar-expand-sm bg-light navbar-light">
		<table class="navbar-nav">
			<tr>
				<td class="nav-item">
					<a class="nav-link h3 "style="border: 1px solid #000;" href="${pageContext.request.contextPath}/board/notice?pageNumber=1">고객센터</a>
				</td>
				<td class="nav-item">
					<a class="nav-link h5" href="${pageContext.request.contextPath}/board/notice?pageNumber=1">공지사항</a>
				</td>
				<td class="nav-item">
