...
<article>
	...
	<div class="container col-sm-6">
		...
		<div class="container" align="center">
			<h2>
				<b style="color: orange;">예약이</b><span>&nbsp;완료되었습니다.</span>
			</h2>
			<br> <br> <br>
			<hr>
		</div>
			...
			<table class="table table-hover">
				<tbody>
					...
					<tr>
						...
						<td>${appointInfo.car_model}/ ${appointInfo.trim_name} /
							${appointInfo.car_year}</td>
					</tr>
					<tr>
						<td id="th_title">방문 예정일</td>
						<td><fmt:formatDate value="${appointInfo.appoint_date }"
					...
					<tr>
						...
						<td>
							<div class="row">
								<div class="col">
									<strong>${appointInfo.branch_name } 지점 </strong><br>
									<br>
								</div>
								...
								<div class="col">
									...
									<script type="text/javascript"
										src="//dapi.kakao.com/v2/maps/sdk.js?appkey=834ff064d4a4d81480636adebb63bc32"></script>
									<script>
        ...
        <td style="color: red;border-bottom: 1px solid silver;">128,000&nbsp;(신용카드)</td>
			...
			<div class="row" align="center">
				<div class="col-sm-12" align="center">
					<div class="row" align="center">
						<button class="col btn  border btn-light"
							onclick="location.href='/'">메인으로 가기</button>
						&nbsp;
						<button class="col btn  border bg-warning" onclick="location.href='/user/myCar'">예약내역 확인</button>
					</div>
				</div>
			</div>
		</div>
