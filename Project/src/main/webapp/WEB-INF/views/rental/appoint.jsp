				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="row">
								<div class="col">
									<strong>${appointInfo.branch_name } 지점 </strong><br> <br>
								</div>
...
// 마커가 표시될 위치입니다 
let markerPosition  = new kakao.maps.LatLng(${appointInfo.gps}, ${appointInfo.gps2}); 
...
/* let iwContent = '<div style="padding:5px;"> <br><a href="https://map.kakao.com/link/map/Hello World!,33.450701,126.570667" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/Hello World!,33.450701,126.570667" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
